...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll(
        '.hero-content, .about-text, .highlight-item, .timeline-item, .skill-category, .project-card, .contact-content'
    );
...
// Progressive Enhancement: Add CSS custom properties for JavaScript
...
// Add CSS for active nav link if not already in CSS
const style = document.createElement('style');
style.textContent = `
    .nav-link.active {
